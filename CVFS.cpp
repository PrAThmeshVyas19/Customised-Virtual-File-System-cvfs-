...
void DisplayHelp()
{
    ...
    printf("read : To read the comments from the file\n");
...
void man(char * name)
{
    ...
    {
        printf("Description : Ussed to write into regular file \n");
    ...
    {
        printf("Description : Used to remoce data from file\n");
